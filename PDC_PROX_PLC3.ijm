...
infected_min_size=4000;
infected_max_size=20000;
infected_min_intensity=2500;
pdc_min_intensity=15000;
pdc_min_size=500;
pdc_max_size=5000;
...
run("Fill Holes");
run("Watershed");
run("Analyze Particles...", "size="+pdc_min_size+"-"+pdc_max_size+" show=Masks exclude clear add");
run("Grays");
rename("pdc");
close("temp");
roiManager("Deselect");
